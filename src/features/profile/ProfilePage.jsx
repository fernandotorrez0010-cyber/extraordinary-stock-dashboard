...
import { formatDate, COUNTRIES } from "../../utils/helpers";
    ...
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="card p-6 flex flex-col items-center text-center">
          ...
          <div className="mt-2">
            <span
              className={`badge text-xs ${profile?.role === "admin" ? "text-blue-400 bg-blue-400/10" : "text-green-400 bg-green-400/10"}`}
            >
              {profile?.role}
            </span>
          </div>
          ...
          <div className="w-full mt-6 space-y-3 text-left">
            {[
              ...
              { icon: Shield, label: "KYC", value: "Pending" },
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-sm text-slate-300 truncate capitalize">
                    {value || "—"}
                  </p>
                </div>
              </div>
