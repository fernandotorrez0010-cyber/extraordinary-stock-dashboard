    ...
    <div>
          ...
          <div className="space-y-3">
            {pending.map((tx) => (
              <div key={tx.id} className="card p-5">
                <div className="flex flex-col lg:flex-row items-start justify-between flex-wrap gap-4">
      ...
      {withdrawals.length === 0 && (
        <EmptyState
          ...
          description="User withdrawal requests will appear here."
        />
      )}
    </div>
  );
